    ...
    return (
        <div className="flex  w-screen h-screen">
            <div className="flex flex-col items-center  justify-center h-auto mt-4 w-screen">
                ...
                {/*first 4 cards*/}
                <div className='flex flex-col w-screen gap-8 h-screen' >
                    {/*first 4 cards*/}
                    <div className='flex flex-row gap-4 justify-center w-auto' onClick={handleClick}>

                        <div id='cards' className={`w-96 h-auto rounded-3xl flex flex-col text-center items-center shadow-lg shadow-slate-500`} onClick={handleClick}>
                            <h1 className=" font-news text-2xl font-bold  "> Graphic Design</h1>
                            {isClicked ? (
                                <div className='border-t-2 w-auto h-auto  font-newsa text-center  '>
                                ...
                                <img src="illustration_3940056.png" width={300} height={300} className='xl:w-64 rounded-3xl w-64' alt="Description of the image" />
                        ...
                        <div id='cards' className={`w-96 h-auto rounded-3xl flex flex-col text-center items-center shadow-lg shadow-slate-500`} onClick={handleClick}>
                            <h1 className=" font-news text-2xl font-bold  "> Teaching</h1>
                            {isClicked ? (
                                <div className='border-t-2 w-auto h-auto  font-newsa text-center  '>
                                ...
                                <img src="teacher_1995574.png" width={300} height={300} className='xl:w-64 rounded-3xl w-64' alt="Description of the image" />
                        ...
                        <div id='cards' className={`w-96 h-auto rounded-3xl flex flex-col text-center items-center shadow-lg shadow-slate-500`} onClick={handleClick}>
                            <h1 className=" font-news text-2xl font-bold  "> Marketing</h1>
                            {isClicked ? (
                                <div className='border-t-2 w-auto h-auto  font-newsa text-center  '>
                                ...
                                <img src="target_5677000.png" width={300} height={300} className='xl:w-64 rounded-3xl w-64' alt="Description of the image" />
                        ...
                        <div id='cards' className={`w-96 h-auto rounded-3xl flex flex-col text-center items-center shadow-lg shadow-slate-500`} onClick={handleClick}>
                            <h1 className=" font-news text-2xl font-bold  "> Entrepreneurship:</h1>
                            {isClicked ? (
                                <div className='border-t-2 w-auto h-auto  font-newsa text-center  '>
                                ...
                                <img src="entre.jpg" width={300} height={300} className='xl:w-64 rounded-3xl w-64' alt="Description of the image" />
                    ...
                    <div className='flex flex-row justify-center gap-4 w-auto'>
                        {/*last 4 cards*/}
                        <div id='cards' className={`w-96 h-auto rounded-3xl flex flex-col text-center items-center shadow-lg shadow-slate-500`} onClick={handleClick}>
                            <h1 className=" font-news text-2xl font-bold  ">Social Work:</h1>
                            {isClicked ? (
                                <div className='border-t-2 w-auto h-auto  font-newsa text-center  '>
                                ...
                                <img src="social.jpg" width={300} height={300} className='xl:w-64 rounded-3xl w-64' alt="Description of the image" />
                        ...
                        <div id='cards' className={`w-96 h-auto rounded-3xl flex flex-col text-center items-center shadow-lg shadow-slate-500`} onClick={handleClick}>
                            <h1 className=" font-news text-2xl font-bold  "> Software Development:</h1>
                            {isClicked ? (
                                <div className='border-t-2 w-auto h-auto  font-newsa text-center  '>
                                ...
                                <img src="se.jpg" width={300} height={300} className='xl:w-64 rounded-3xl w-64' alt="Description of the image" />
                        ...
                        <div id='cards' className={`w-96 h-auto rounded-3xl flex flex-col text-center items-center shadow-lg shadow-slate-500`} onClick={handleClick}>
                            <h1 className=" font-news text-2xl font-bold  "> Data Science:</h1>
                            {isClicked ? (
                                <div className='border-t-2 w-auto h-auto  font-newsa text-center  '>
                        ...
                        <div id='cards' className={`w-96 h-auto rounded-3xl flex flex-col text-center items-center shadow-lg shadow-slate-500`} onClick={handleClick}>
                            <h1 className=" font-news text-2xl font-bold  ">  Healthcare:</h1>
                            {isClicked ? (
                                <div className='border-t-2 w-auto h-auto  font-newsa text-center  '>
                                ...
                                <img src="health.jpg" width={300} height={300} className='xl:w-64 rounded-3xl w-64' alt="Description of the image" />
                    ...
                    <div className='flex flex-row gap-4 w-auto justify-center' onClick={handleClick}>


                        {/* card1 */}

                        <div id='cards' className={`w-96 h-auto rounded-3xl flex flex-col text-center items-center shadow-lg shadow-slate-500 `} onClick={handleClick}>
                            <h1 className=" font-news text-2xl font-bold  ">  Engineering:</h1>
                            {isClicked ? (
                                <div className='border-t-2 w-auto h-auto  font-newsa text-center  '>
                                ...
                                <img src="enginer.jpg" width={300} height={300} className='xl:w-64 rounded-3xl w-64' alt="Description of the image" />

                            )}
                        </div>
                        {/* card1 */}
                        <div id='cards' className={`w-96 h-auto rounded-3xl flex flex-col text-center items-center shadow-lg shadow-slate-500`} onClick={handleClick}>
                            <h1 className=" font-news text-2xl font-bold  "> Environmental Science:</h1>
                            {isClicked ? (
                                <div className='border-t-2 w-auto h-auto  font-newsa text-center  '>
                                ...
                                <img src="enviro.jpg" width={300} height={300} className='xl:w-64 rounded-3xl w-64' alt="Description of the image" />
